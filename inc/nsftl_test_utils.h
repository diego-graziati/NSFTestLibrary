 ...
 * @returns NSFTL_MEMORY_ALLOCATION_FAILED_MEMORY_INSUFFICIENT, NSFTL_REPORT_MESSAGE_IS_TOO_LONG, NSFTL_SUCCESS
 */
 ...
 * @returns NSFTL_UNABLE_TO_SUBMIT_TEST_FUNCTION_TO_TEST_UNIT, NSFTL_SUCCESS
 */
