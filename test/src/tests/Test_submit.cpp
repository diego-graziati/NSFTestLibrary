...
void Test::submit_test_to_single_test_unit(mytest_report_type_t& report)
{
...
void Test::submit_test_to_multiple_test_units(mytest_report_type_t& report)
{
    ...
    for (uint32_t i = 0U; i < test::MAX_TEST_UNITS_ARRAY_LENGTH; i++)
    {
        ...
        status = mytest_submit_test_to_test_unit(test_unit[i], Test::test_callback_fn);
